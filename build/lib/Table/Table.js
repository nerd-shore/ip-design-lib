...
var Table = (function (_super) {
    ...
    function Table() {
        ...
        _this.renderRow = function (data, rowKey) {
            var _a = _this.props, columns = _a.columns, operationsClass = _a.operationsClass, renderSubPanel = _a.renderSubPanel, selectedRow = _a.selectedRow, customRowKey = _a.customRowKey;
            var newRowKey = customRowKey ? data[customRowKey] : rowKey;
            var element = [];
                ...
                switch (column.type) {
                    case 'select':
                        element.push(React.createElement("div", { className: "\n                column_select\n                " + (column.classNames ? column.classNames : '') + "\n              ", key: "select-" + key },
                            React.createElement(Checkbox_1.Checkbox, { onChange: function (e, checked) { return _this.handleColumnClick(column, data, newRowKey, checked); }, id: "single" })));
                        break;
                    case 'expand':
                        element.push(React.createElement("div", { className: "\n                column_toggle\n                " + (column.classNames ? column.classNames : '') + "\n              ", key: "expand-" + key, onClick: function () { return _this.handleColumnClick(column, data, newRowKey); } },
                            React.createElement("i", { className: "material-icons" }, "keyboard_arrow_down")));
                        break;
                    case 'operations':
                        var operations = _this.buildOperations(column.operations, data, newRowKey);
                        element.push(React.createElement("div", { key: "operations-" + key, className: "\n                column_operation\n                " + (operationsClass ? operationsClass : '') + "\n                " + (column.classNames ? column.classNames : '') + "\n              " }, operations));
                        break;
                    case 'render':
                        var render = column.render(data, newRowKey);
                        element.push(render);
                        break;
                    case 'chip':
                        var chip = (React.createElement("div", { key: "default-" + key, className: "\n                  column-chip\n                  " + (column.small ? 'column--small' : '') + "\n                  " + (column.classNames ? column.classNames : '') + "\n                " },
                            React.createElement(Chip_1.Chip, { title: data[column.definition], id: newRowKey + "-" + key, deletable: false, fullWidth: column.fullWidth, selectable: column.selectable, onClick: function () { return _this.handleColumnClick(column, data, newRowKey); } })));
                        element.push(chip);
                        break;
                    case 'date':
                        var date = data[column.definition];
                        date = column.formater(date);
                        element.push(React.createElement("div", { key: "default-" + key, className: "\n                  " + (column.small ? 'column--small' : '') + "\n                  " + (column.classNames ? column.classNames : '') + "\n                ", onClick: function () { return _this.handleColumnClick(column, data, newRowKey); } }, date));
                        break;
                    case 'link':
                    ...
                    default:
                        ...
                        var domElement = null;
                        domElement = (React.createElement("div", { key: "default-" + key, className: "\n                " + (column.small ? 'column--small' : '') + "\n                " + (column.classNames ? column.classNames : '') + "\n              ", onClick: function () { return _this.handleColumnClick(column, data, newRowKey); } }, content));
                        element.push(domElement);
                        break;
                }
            });
            return (React.createElement(React.Fragment, { key: "t_fragment-" + newRowKey },
                React.createElement("div", { className: "\n            table_content\n            " + (selectedRow === newRowKey ? 'table_selected-row' : '') + "\n          ", onClick: function () { return _this.handleRowClick(data, newRowKey); } }, element),
                renderSubPanel ?
                    React.createElement("div", { className: "table_row_sub-panel " + (selectedRow === newRowKey ? 'table_selected-row' : '') }, renderSubPanel(data, newRowKey)) : null));
        };
        return _this;
    }
