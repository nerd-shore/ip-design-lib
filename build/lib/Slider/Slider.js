...
var Slider = (function (_super) {
    ...
    Slider.prototype.render = function () {
        var _a = this.props, _b = _a.orientation, orientation = _b === void 0 ? 'horizontal' : _b, classNames = _a.classNames, min = _a.min, _c = _a.max, max = _c === void 0 ? 100 : _c, labelBefore = _a.labelBefore, labelAfter = _a.labelAfter, disabled = _a.disabled;
        ...
        return (React.createElement("div", { className: "\n          slider\n          " + (classNames ? classNames : '') + "\n          " + (orientation ? "slider--" + orientation : 'slider--horizontal') + "\n          " + (labelBefore ? "slider--with-before-label" : '') + "\n          " + (labelAfter ? "slider--with-after-label" : '') + "\n        " },
            ...
            React.createElement("div", { className: "slider_container" },
                ...
                React.createElement("div", { className: "slider-bar", onMouseDown: this.handleDrag, onMouseUp: this.handleEnd, onTouchStart: this.handleStart, onTouchEnd: this.handleEnd, ref: this.handleSliderRef },
                    ...
                    React.createElement("div", { className: "slider_bar--dragged\n                " + (disabled ? 'slider_bar--disabled' : ''), style: draggedBarInlineStyle }),
                    React.createElement("div", { className: "slider_bar_dragger\n                " + (active ? 'slider_bar_dragger--active' : '') + "\n                " + (disabled ? 'slider_bar_dragger--disabled' : ''), style: draggerInlineStyle, onMouseDown: this.handleStart, onTouchMove: this.handleDrag, onTouchEnd: this.handleEnd, onKeyDown: this.handleKeyDown, ref: this.handleDraggerRef }),
