...
var RadioButtons = (function (_super) {
    ...
    RadioButtons.prototype.render = function () {
        var _this = this;
        var _a = this.props, buttons = _a.buttons, disabled = _a.disabled;
        var selectedButton = this.state.selectedButton;
        return (React.createElement("div", { className: "radio-buttons" }, buttons.map(function (button, key) { return (React.createElement("label", { key: key, onClick: function () { return _this.onClick(key, button); }, className: "" + (disabled ? 'radio-button-disabled' : '') },
            React.createElement("input", { tabIndex: key + 1, type: "radio", checked: selectedButton === key, onChange: _this.onChange, className: "" + (disabled ? 'radio-buttons_input--disabled' : '') }),
